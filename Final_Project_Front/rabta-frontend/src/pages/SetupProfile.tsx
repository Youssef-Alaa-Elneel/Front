...
import { Popup } from '../components/ui/Popup'; // تأكدي إن المسار ده صح
...
const SetupProfile: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setShowSuccessPopup(true); // بنظهر البوب أب هنا
  };
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-10">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 mb-6">
                  <div className="w-32 h-32 rounded-full bg-[#FAFAFA] dark:bg-[#171717] border-2 border-dashed border-[#7C3AED] dark:border-[#8B5CF6] flex items-center justify-center text-[#7C3AED] dark:text-[#8B5CF6] transition-colors hover:bg-[#7C3AED]/5 cursor-pointer">
                  ...
                  <div>
                    ...
                    <button type="button" className="bg-[#7C3AED]/10 text-[#7C3AED] hover:bg-[#7C3AED]/20 dark:bg-[#8B5CF6]/20 dark:text-[#8B5CF6] dark:hover:bg-[#8B5CF6]/30 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-300">Upload Image</button>
                  </div>
                </div>
