        ...
        <div className="bg-white dark:bg-[#262626] rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden">
          ...
          <form className="p-6 pt-14 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-end gap-4">
              ...
              <button 
                type="submit" 
                className="px-8 py-2.5 rounded-xl text-sm font-bold text-white bg-[#7C3AED] hover:bg-[#6D28D9] transition-all shadow-lg shadow-purple-200 dark:shadow-none active:scale-95"
              >
                Create Group
              </button>
            </div>
